...
const Login = ({navigation}: RootScreenProps<'Login'>) => {
  ...
  const requestOTP = () => {
    ...
    dispatch<any>(sendOTP({phoneNumber: loginForm.phoneNumber})).then(
      (res: {payload: any}) => {
        if (res.payload) {
          setOtpSent(true);
        }
  ...
  const handleLogin = () => {
    ...
    if (otpSent) {
      ...
      dispatch<any>(
        login({phoneNumber: loginForm.phoneNumber, otp: loginForm.otp}),
      ).then((res: any) => {
        if (res.payload) {
          if (!res.error) {
            clearFields();
      ...
      <View style={styles.loginInputContainer}>
        <TextInputVarient
          ...
          onChangeText={txt => {
            ...
            setLoginForm({...loginForm, phoneNumber: txt});
          }}
        ...
        {otpSent ? (
          ...
          <LinerGradientVarient
            ...
            gradientStyle={[styles.loginBtn, {width: '100%'}]}
            onPress={() => !isLoading && requestOTP()}
      ...
      <View style={styles.loginInputContainer}>
        <TextInputVarient
          ...
          onChangeText={txt => {
            ...
            setLoginForm({...loginForm, email: txt});
          }}
        ...
        <TextInputVarient
          ...
          onChangeText={txt => {
            ...
            setLoginForm({...loginForm, password: txt});
          }}
  ...
  return (
    <SafeScreen>
      <View style={styles.loginContainer}>
        ...
        {loginWithOtp ? renderMobileLoginForm() : renderEmailLoginForm()}
        {/* .. */}
        ...
        <View style={{display: 'flex', alignItems: 'center'}}>
          <Text style={{fontSize: 16, marginTop: 0, color: MAIN_FONT_COLOR}}>
            ...
            <Text
              ...
              onPress={() => !isLoading && handleSignupNavigation()}>
              Signup
            </Text>
          </Text>
        </View>
