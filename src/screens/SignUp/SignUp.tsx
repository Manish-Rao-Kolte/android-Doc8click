      ...
      <ScrollView>
        <View style={styles.loginContainer}>
          ...
          <View style={{alignItems: 'center'}}>
            ...
            <Text style={[styles.loginHeader, {color: THEME_COLOR}]}>
              {' '}
              Doc8click
            </Text>
          </View>
          ...
          {isError && (
            <Text style={[styles.lableText, {color: 'red'}]}>{isError}</Text>
          )}
          ...
          <View style={styles.loginInputContainer}>
            ...
            <TextInputVarient
              ...
              value={fullName}
              icon={require('../../images/input-icon/name.png')}
              onChangeText={handleNameInput}
              errText={errText.fullNameErr}
            />
            {/* Username */}
            <TextInputVarient
              placeholder="Enter Username.."
              value={signupForm.username}
              icon={require('../../images/input-icon/username.png')}
              onChangeText={txt => {
                setErrText({...errText, usernameErr: ''});
                setSignupForm({...signupForm, username: txt});
              }}
              errText={errText.usernameErr}
            />
            {/* Email */}
            <TextInputVarient
              placeholder="Enter Email.."
              value={signupForm.email}
              icon={require('../../images/input-icon/email.png')}
              onChangeText={txt => {
                setErrText({...errText, emailErr: ''});
                setSignupForm({...signupForm, email: txt});
              }}
              errText={errText.emailErr}
            />
            {/* Phone number */}
            <TextInputVarient
              ...
              icon={require('../../images/input-icon/mobile.png')}
              onChangeText={txt => {
                setErrText({...errText, phoneNumberErr: ''});
                setSignupForm({...signupForm, phoneNumber: txt});
              }}
              errText={errText.phoneNumberErr}
            />
            {/* Gender */}
            <GenderSelect
              selectedGender={signupForm.gender}
              onGenderSelect={(val: string) =>
            ...
            <TextInputVarient
              ...
              icon={require('../../images/input-icon/password.png')}
              onChangeText={txt => {
                setErrText({...errText, passwordErr: ''});
                setSignupForm({...signupForm, password: txt});
              }}
              viewPassword={viewPassword}
              setViewPassword={setViewPassword}
              viewIcon={require('../../images/input-icon/view.png')}
              hideIcon={require('../../images/input-icon/hide.png')}
              type="password"
              errText={errText.passwordErr}
            />
            {/* Confirm Password */}
            <TextInputVarient
              placeholder="Confirm Password.."
              value={signupForm.confirmPassword}
              icon={require('../../images/input-icon/cnf-password.png')}
              onChangeText={txt => {
                setErrText({...errText, confirmPasswordErr: ''});
                setSignupForm({...signupForm, confirmPassword: txt});
              }}
              errText={errText.confirmPasswordErr}
            />
          </View>

          <LinerGradientVarient
            gradientColors={[BLUE_COLOR1, BLUE_COLOR2, BLUE_COLOR3]}
            gradientStyle={[styles.loginBtn]}
